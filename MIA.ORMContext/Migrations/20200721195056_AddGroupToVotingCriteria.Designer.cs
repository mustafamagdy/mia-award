...
namespace MIA.ORMContext.Migrations
{
    ...
    [Migration("20200721195056_AddGroupToVotingCriteria")]
    partial class AddGroupToVotingCriteria
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MIA.Models.Entities.SystemOptions", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<bool>("AllJudgeFinished");
            ...
            modelBuilder.Entity("MIA.Models.Entities.AppUser", b =>
                {
                    b.OwnsOne("MIA.Models.Entities.S3File", "ProfileImage", b1 =>
                        {
                            ...
                            b1.HasOne("MIA.Models.Entities.AppUser")
                                .WithOne("ProfileImage")
                                .HasForeignKey("MIA.Models.Entities.S3File", "AppUserId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("MIA.Models.Entities.Award", b =>
                {
                    ...
                    b.HasOne("MIA.Models.Entities.AppUser", "Manager")
                        .WithMany()
