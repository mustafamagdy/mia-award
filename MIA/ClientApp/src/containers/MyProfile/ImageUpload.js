...
class ImageUpload extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className={`modal-wrap ${isOpen === true ? "modal-ready" : ""}`}
        id="js-open-change-pass"
          ...
          <div className="modal-content" style={{ textAlign: "center" }}>
            <div className="popup popup--cp">
              <div className="popup-logo">
                <div className="popup-logo__title">
                  {" "}
                  <Trans id="mia"> MIA </Trans>{" "}
                </div>
              </div>
              <div className="popup__title popup__title--md">
                {" "}
                <Trans id="upload_avatar"> Upload Avatar </Trans>{" "}
              </div>
              ...
              >
                {" "}
                <Trans id="select_your_image"> Select Your Image </Trans>{" "}
              </span>
              <div className="form-group">
                ...
                >
                  <span className="button__text">
                    <Trans id="upload_image">
                      {" "}
                      <Trans id="upload_image"> Upload Image </Trans>{" "}
                    </Trans>
                  </span>
                </button>
              </div>
