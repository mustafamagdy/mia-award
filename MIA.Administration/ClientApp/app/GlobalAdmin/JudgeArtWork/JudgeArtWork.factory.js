(function () {
    ...
    function JudgeArtWorkResource($resource, appCONSTANTS) {
        return $resource(appCONSTANTS.API_URL + 'judgeVote', {}, {
            ...
            getArtworkStatistics: { method: 'POST', url: appCONSTANTS.API_URL + 'artWorks/artwork-statistics',isArray: true, useToken: true },
            ...
            getCriteriaByLevel: { method: 'GET', url: appCONSTANTS.API_URL + 'judgeVote/:artworkId/getCriteriaByLevel/:level', isArray: true, useToken: true },
