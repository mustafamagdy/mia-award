(function () {
  ...
  angular.module("home").config(function ($stateProvider, $urlRouterProvider) {
    $stateProvider
      .state("JudgeArtWork", {
        url: "/JudgeArtWork",
        templateUrl:
          "./app/GlobalAdmin/JudgeArtWork/templates/JudgeArtWork.html",
      ...
      .state("displayVideo", {
        url: "/displayVideo/:id",
        templateUrl:
          "./app/GlobalAdmin/JudgeArtWork/templates/displayVideo.html",
      ...
      .state("artWorkDetails", {
        ...
        templateUrl:
          "./app/GlobalAdmin/JudgeArtWork/templates/artworkdetails.html",
        ...
        data: {
          permissions: {
            only: ["Judge.view_artwork_scores"],
            redirectTo: "root",
          },
        },
      })
      .state("my-dashboard", {
        url: "/my-dashboard",
        templateUrl:
          "./app/GlobalAdmin/JudgeArtWork/templates/judge-dashboard.html",
      ...
      .state("my-judges", {
        ...
        data: {
          permissions: {
            only: ["Admin.view_award","Judge.list_my_judges"],
            redirectTo: "root",
          },
        },
      })
      .state("artwork-statistics", {
        ...
        templateUrl:
          "./app/GlobalAdmin/JudgeArtWork/templates/artwork-statistics.html",
      ...
      .state("artwork-votes", {
        url: "/artwork-votes",
        templateUrl:
          "./app/GlobalAdmin/JudgeArtWork/templates/artwork-vote-details.html",
  ...
  function JudgeArtWorkPrepService(JudgeArtWorkResource) {
    return JudgeArtWorkResource.getAllJudgeArtWorks({
      pageNumber: 1,
      pageSize: 10,
    }).$promise;
  }

  JudgeArtWorkByIdPrepService.$inject = [
    "JudgeArtWorkResource",
    "$stateParams",
  ];
  function JudgeArtWorkByIdPrepService(JudgeArtWorkResource, $stateParams) {
    return JudgeArtWorkResource.getJudgeArtWork({ id: $stateParams.id })
      .$promise;
  }
  ...
  JudgeArtWorkDetailsByArtWorkIdPrepService.$inject = [
    "JudgeArtWorkResource",
    "$stateParams",
  ];
  function JudgeArtWorkDetailsByArtWorkIdPrepService(
    JudgeArtWorkResource,
    $stateParams
  ) {
    return JudgeArtWorkResource.getJudgeArtWorkDetails({ id: $stateParams.id })
      .$promise;
  }
  ...
  function ArtWorkWithFilesByIdPrepService(ArtWorkResource, $stateParams) {
    return ArtWorkResource.getArtWorkWithFiles({ id: $stateParams.id })
      .$promise;
  }
  ArtWorkWithFilesAndScoresByIdPrepService.$inject = [
    "JudgeArtWorkResource",
    "$stateParams",
  ];
  function ArtWorkWithFilesAndScoresByIdPrepService(
    JudgeArtWorkResource,
    $stateParams
  ) {
    return JudgeArtWorkResource.getArtWorkWithFilesAndScore({
      id: $stateParams.id,
  ...
  ArtworkStatisticsPrepService.$inject = [
    "JudgeArtWorkResource",
    "$stateParams",
  ];
  function ArtworkStatisticsPrepService(JudgeArtWorkResource, $stateParams) {
    return JudgeArtWorkResource.getArtworkStatistics({
      pageSize: 10,
      pageNumber: 1,
    }).$promise;
  }
