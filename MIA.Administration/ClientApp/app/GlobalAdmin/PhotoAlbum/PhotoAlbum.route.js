(function () {
  ...
  function PhotoAlbumPrepService(PhotoAlbumResource) {
    return PhotoAlbumResource.getAllPhotoAlbums({ pageNumber: 1, pageSize: 10 })
      .$promise;
  }
  ...
  function AllAwardPrepService(PhotoAlbumResource) {
    return PhotoAlbumResource.getAllAwards({ pageNumber: 1, pageSize: 10 })
      .$promise;
  }
