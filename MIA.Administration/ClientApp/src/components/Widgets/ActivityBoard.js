  ...
  render() {
    ...
    return (
      <div className="activity-board-wrapper">
        {this.state.sectionReload && <RctSectionLoader />}
        <Scrollbars className="rct-scroll" autoHeight autoHeightMin={100} autoHeightMax={600} autoHide>
          <ul className="mb-0 list-unstyled">
            ...
            <li>
              <div className="activity-heading d-flex p-4 border-bottom">
                <h3 className="mb-0">
                  <Trans id="widgets.checklist" />
                </h3>
              </div>
              <div className="p-4">
                <Progress color="primary" className="mb-3" value="80">
                  80% Completed
                </Progress>
                <List className="p-0">
                  {activityData &&
                    activityData.map((task, key) => (
