      ...
      return (
         <Card className="rct-block">
            <CardBody className="pb-0 d-flex justify-content-between">
               <h4 className="mb-5"><Trans id="components.followers" /></h4>
               <p className="fs-14 mb-0"><Trans id="components.trending" />: 29% <i className="ti-arrow-up text-success ml-1"></i></p>
            </CardBody>
            <List className="p-0">
               <ListItem className="d-flex justify-content-between border-bottom py-5 fs-14 px-20">
                  <span><Trans id="widgets.lastWeek" /></span>
                  <span>5400</span>
                  <span><i className="ti-arrow-up text-success mr-5"></i>20%</span>
               </ListItem>
               <ListItem className="d-flex justify-content-between border-bottom py-5 fs-14 px-20">
                  <span><Trans id="widgets.thisWeek" /></span>
                  <span>2400</span>
