      ...
      <div className="lazy-up">
        <div className="card pt-30">
          ...
          <div className="card-foot d-flex align-self-end">
            <Button variant="contained" size="small" onClick={() => this.onAccept()} className="btn-primary mr-5 mb-10 text-white">
              <Trans id="button.accept" />
            </Button>
            <Button variant="contained" size="small" onClick={() => this.onReject()} className="btn-warning mb-10 text-white">
              <Trans id="button.reject" />
            </Button>
          </div>
        </div>
