                    ...
                    return (
                      <Fragment key={index}>
                        ...
                        >
                          <span className="menu">
                            <Trans id={subMenu.menu_title} />
                            {menu.new_item && menu.new_item === true ? <Chip label="new" className="new-item" color="secondary" /> : null}
                          </span>
                        </ListItem>
                              ...
                              <ListItem button component="li" key={nestedKey}>
                                <NavLink activeClassName="item-active" to={nestedMenu.path}>
                                  <span className="menu pl-10 d-inline-block">
                                    <Trans id={nestedMenu.menu_title} />
