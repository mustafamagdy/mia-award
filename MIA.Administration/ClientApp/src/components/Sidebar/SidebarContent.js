      ...
      <div className="rct-sidebar-nav">
        <nav className="navigation">
          ...
          {/* <List
					...
					<List
						className="rct-mainMenu p-0 m-0 list-unstyled"
						subheader={<ListSubheader className="side-title" component="li"><Trans id="sidebar.features" /></ListSubheader>}
					>
					...
					<List
						className="rct-mainMenu p-0 m-0 list-unstyled"
						subheader={<ListSubheader className="side-title" component="li"><Trans id="sidebar.applications" /></ListSubheader>}
					>
					...
					<List
						className="rct-mainMenu p-0 m-0 list-unstyled"
						subheader={<ListSubheader className="side-title" component="li"><Trans id="sidebar.extensions" /></ListSubheader>}
					>
