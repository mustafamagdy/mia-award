...
const BoothList = ({ booth, loading, booth_metadata, fetchBooth, deleteBooth, saveBooth, updateBooth, match }) => {
  const title = "booth";
...
const mapStateToProps = ({ booths: { booth, loading, booth_metadata } }) => ({ booth, loading, booth_metadata });
