          ...
          <div className="row">
            <div className="col-sm-12 col-md-5 col-lg-4 w-xs-full">
              <div className="dash-cards">
                <a href="#" onClick={e => e.preventDefault()} className="square-40 bg-warning card-right-action">
                ...
                <div className="card">
                  <div className="media">
                    ...
                    <div className="media-body pt-10">
                      ...
                      <Button variant="contained" className="btn-primary text-white btn-icon mr-10 mb-10">
                        Accept <i className="zmdi zmdi-check-circle"></i>
                      </Button>
                      <Button variant="contained" className="btn-warning text-white btn-icon mr-10 mb-10">
                        Reject <i className="zmdi zmdi-delete"></i>
                      </Button>
                    </div>
                  </div>
                </div>
